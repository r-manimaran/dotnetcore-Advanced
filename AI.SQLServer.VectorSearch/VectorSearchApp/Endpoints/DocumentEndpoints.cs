...
public class DocumentEndpoints : IEndpointRouteHandlerBuilder
{
    public static void MapEndpoints(IEndpointRouteBuilder endpoints)
    {
        ...
        documentApiGroup.MapGet("{documentId:guid}/chunks/{documentChunkId:guid}", async Task<Results<Ok<DocumentChunk>,NotFound>> ([FromRoute] Guid documentId, [FromRoute] Guid documentChunkId, [FromServices] DocumentService documentService, CancellationToken cancellationToken) =>
        {
        ...
        documentApiGroup.MapDelete("{documentId:guid}", async ([FromRoute] Guid documentId, [FromServices]  DocumentService documentService, CancellationToken cancellationToken) =>
        {
